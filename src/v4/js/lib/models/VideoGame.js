...
var VideoGame = /** @class */ (function () {
    ...
    VideoGame.getTournamentsRaw = function (filter, options) {
        if (options === void 0) { options = VideoGame.getDefaultTournamentOptions(); }
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NetworkInterface_1.default.paginatedQuery("Finding tournaments with filter:" + JSON.stringify(filter), queries.tournaments, { filter: filter }, options, {}, 3)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, lodash_1.default.flatten(data.map(function (d) { return d.tournaments.nodes; }))];
                }
            });
        });
    };
