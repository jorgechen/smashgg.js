...
const testData = __importStar(require("./data/stream.testData"));
...
describe('smashgg Stream', function () {
    ...
    before(async function () {
        ...
        stream1 = await Stream_1.Stream.get(STREAM_ID_1);
        stream2 = await Stream_1.Stream.get(STREAM_ID_2);
        stream3 = await Stream_1.Stream.get(STREAM_ID_3);
        return true;
    });
    // id
