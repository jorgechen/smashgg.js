...
describe('smash.gg Attendee (Participant)', function () {
    ...
    // phases entered
    it('should get the correct phases an attendee entered 1', function () {
        return __awaiter(this, void 0, void 0, function () {
            var actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(5000);
                        return [4 /*yield*/, attendee1.getEnteredPhases()];
                    case 1:
                        actual = _a.sent();
                        chai_1.expect(actual.length).to.be.greaterThan(0);
                        actual.forEach(function (data) {
    ...
    it('should get the correct phases an attendee entered 2', function () {
        return __awaiter(this, void 0, void 0, function () {
            var actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(5000);
                        return [4 /*yield*/, attendee2.getEnteredPhases()];
                    case 1:
                        actual = _a.sent();
                        chai_1.expect(actual.length).to.be.greaterThan(0);
                        actual.forEach(function (data) {
    ...
    it('should get the correct phase groups an attendee entered 1', function () {
        return __awaiter(this, void 0, void 0, function () {
            var actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(5000);
                        return [4 /*yield*/, attendee1.getEnteredPhaseGroups()];
                    case 1:
                        actual = _a.sent();
                        chai_1.expect(actual.length).to.be.greaterThan(0);
                        actual.forEach(function (data) {
    ...
    it('should get the correct phase groups an attendee entered 2', function () {
        return __awaiter(this, void 0, void 0, function () {
            var actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(5000);
                        return [4 /*yield*/, attendee2.getEnteredPhaseGroups()];
                    case 1:
                        actual = _a.sent();
                        chai_1.expect(actual.length).to.be.greaterThan(0);
                        actual.forEach(function (data) {
